...
pub fn JS_VALUE_GET_FLOAT64(arg_v: JSValue) callconv(.C) f64 {
    ...
    u.v = v;
    u.v +%= @as(u64, @bitCast(@as(c_longlong, (@as(c_int, 2146959360) - JS_TAG_FIRST) + @as(c_int, 1)))) << @intCast(32);
    return u.d;
}
...
pub const __REDIR = @compileError("unable to translate macro: undefined identifier `__typeof__`"); // /usr/lib/zig/libc/include/wasm-wasi-musl/features.h:38:9
...
pub const js_force_inline = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // ./src/vendor/quickjs.h:38:9
pub const __js_printf_like = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // ./src/vendor/quickjs.h:39:9
pub const JS_PTR64_DEF = @compileError("unable to translate C expr: unexpected token 'Eof'"); // ./src/vendor/quickjs.h:60:9
...
pub const JS_CFUNC_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1007:9
pub const JS_CFUNC_MAGIC_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1008:9
pub const JS_CFUNC_SPECIAL_DEF = @compileError("unable to translate macro: undefined identifier `JS_CFUNC_`"); // ./src/vendor/quickjs.h:1009:9
pub const JS_ITERATOR_NEXT_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1010:9
pub const JS_CGETSET_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1011:9
pub const JS_CGETSET_MAGIC_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1012:9
pub const JS_PROP_STRING_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1013:9
pub const JS_PROP_INT32_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1014:9
pub const JS_PROP_INT64_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1015:9
pub const JS_PROP_DOUBLE_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1016:9
pub const JS_PROP_UNDEFINED_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1017:9
pub const JS_OBJECT_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1018:9
pub const JS_ALIAS_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1019:9
pub const JS_ALIAS_BASE_DEF = @compileError("unable to translate C expr: unexpected token '{'"); // ./src/vendor/quickjs.h:1020:9
...
pub const __VERSION__ = "Alpine Clang 16.0.6";
...
pub const JS_FLOAT64_TAG_ADDEND = (@import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7ff80000, .hexadecimal) - JS_TAG_FIRST) + @as(c_int, 1);
pub const JS_NAN = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7ff8000000000000, .hexadecimal) - (@import("std").zig.c_translation.cast(u64, JS_FLOAT64_TAG_ADDEND) << @as(c_int, 32));
